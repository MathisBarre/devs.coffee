...
export default function Events({ trainingDevEvents }: IeventsProps) {
  ...
  const events: Ievent[] = localEvents
      ...
      >
        <div className="bg-white dark:bg-gray-900 overflow-hidden">
          {events.length !== 0 ? (
            ...
            <p className="border border-gray-200 dark:border-gray-1000 text-black dark:text-white text-opacity-50 text-center py-10 my-4 dark:bg-gray-1000 rounded">
