      ...
      <div className="container mx-auto pt-16 grid lg:grid-cols-12 lg:gap-8 box-border px-4">
        <section className="flex flex-col items-center lg:col-span-4  lg:p-0 mb-16">
          ...
          <div className="flex flex-col md:flex-row lg:flex-col">
            <img className="hidden md:block w-32 h-32 lg:w-full lg:h-auto object-cover lg:my-4 rounded-full lg:rounded mr-4" src="/images/profil.jpg" alt=""/>
            <div>
        ...
        <form className="lg:col-span-8 flex flex-col" action="https://formspree.io/f/xnqolblw" method="POST">
          <h2 className="dark:text-white text-2xl font-bold mb-4">Envoyer un message</h2>
          <label className="dark:text-white block mb-1" htmlFor="name">Contact</label>
          <input 
            className="w-full rounded mb-4 dark:bg-gray-1000 border dark:border-gray-1100 text-white" 
